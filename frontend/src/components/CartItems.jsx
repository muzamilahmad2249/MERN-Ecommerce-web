    ...
    {/* cart details */}
        <div className='flex flex-col gap-20 my-16 p-8 md:flex-row rounded-md bg-white w-full max-w-[666px]'>
          <div className='flex flex-col gap-10'>
            ...
            <div className='flex flex-col gap-10'>
              <h4 className='bold-20  capitalize'>Your coupen code enter here:</h4>
              <div className='flexCenter pl-5 h-12 bg-primary rounded-full right-1 ring-slate-900/10 '>
                <input type="text" placeholder='Your Coupen' className='bg-transparent border-none outline-none' />
